...
// useSearchParams ን የሚጠቀመውን ክፍል ወደዚህ ኮምፖኔንት አንቀሳቅሰናል
...
// ዋናው ገጽ - እዚህ ላይ Suspense በመጠቀም TrackOrderContent ን እንጠራለን
export default function TrackOrderPage() {
  return (
    <PublicLayout>
      <Suspense fallback={<div className="container mx-auto px-4 py-8 text-center">Loading order tracker...</div>}>
        <TrackOrderContent />
      </Suspense>
    </PublicLayout>
  );

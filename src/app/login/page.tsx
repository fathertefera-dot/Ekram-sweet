...
// useSearchParams ን የሚጠቀመውን ክፍል ለይተን አዲስ ኮምፖኔንት ፈጥረናል
...
// ዋናው ገጽ (Main Page) - እዚህ ላይ Suspense በመጠቀም LoginContent ን እንጠራለን
export default function LoginPage() {
  return (
    <PublicLayout>
      <div className="container mx-auto px-4 py-16 max-w-md">
        <Card className="border-0 shadow-lg">
          <Suspense fallback={<div className="p-8 text-center">በመጫን ላይ...</div>}>
            <LoginContent />
          </Suspense>
        </Card>
      </div>
